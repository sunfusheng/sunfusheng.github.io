...
查看具体操作代码请参考 [《个人学习项目DroidStudy》](https://github.com/sunfusheng/In-depthStudy)，感谢您的关注。
...
以上把这些技术点总结出来，后面我会把多线程这块的示例代码更新到 [《个人学习项目DroidStudy》](https://github.com/sunfusheng/In-depthStudy)，感谢您的关注。

## ● 线程池

创建多个线程不光麻烦而且相对影响系统性能，接下来让我看看使用线程池来操作多线程。我把自己的 [《个人学习项目DroidStudy》](https://github.com/sunfusheng/In-depthStudy) 中线程池转成一个 gif 效果图，大家可以实际把玩下去感受线程池的原理，有兴趣的同学也可以先 star 下，我会在接下来的几个月把这个学习的Demo工程完善好。

<img src="/assets/2016/gif_thread_pool.gif" style="width: 50%;">
